...
PrivateData = @{
    ...
    PSData = @{
        ...
        # Tags applied to this module. These help with module discovery in online galleries.
          Tags = @('PSEdition_Desktop','UCSPowerTool', 'CiscoUCSCmdlets','PowerToolCmdlets')
        ...
        # ReleaseNotes of this module
         ReleaseNotes = 'Cisco.UCSManager.Cmdlets -Version 2.5.3.0
December 2019

Key Features in Release:
    Support for new features in Cisco UCSM Release 4.0(4f).
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8Af53QiZJupxd
# MACQRXdS0i44KkdzxUuFKrONgW+1+KCCE08wggQVMIIC/aADAgECAgsEAAAAAAEx
...
# IgQgn0uEf5aVsnTUgjdKWQeJvY5r5wCL7ZM3b6SzfpaX2YgwDQYJKoZIhvcNAQEB
# BQAEggEAALzckVHhdYHOWzWOeVCux8ebKGJPh+vNseuoKihOYJ1BNqNkYtCJNMM2
# 9+/B6p0pzm/6c8WNDm/peILTEAadVkWIbhI9NP/ILSqGbktqrVv8uIQGdUbX3CPP
# PLEjZ7/UcL+muUUKP1NFmxqPW0DlcFDSrLJKVLhMT5zl0VI3KEbEmly/Ua4QnE4S
# FlO4Jf5pBtv1wrlCupP//hiHgZZ7JYbZbtmfDEobnjwiKuSTALzilnboDnwkp4N4
# u0k+dDmo1932H8nS+N+2uIvLKGPvwIFKn6ZfwzbeLvckvEya0mPsj+UnLqtmXQ00
# z6rYO/uEigwOXDf0TARqKdK9aPmijaGCArkwggK1BgkqhkiG9w0BCQYxggKmMIIC
...
# KoZIhvcNAQkEMSIEICdecZVp6+RRYQBnxl3d2GLZOpFAgHTmTlmo7LwOGcp9MIGg
...
# RzICDCRUuH8eFFOtN/qheDANBgkqhkiG9w0BAQEFAASCAQCn75/EJ4kqp8Un9lgi
# SLDDXnmIwpGW5r4JlRMuTDXXLEoxb/IhYAhLCDEMdIrxUUymHwopUqr2UpzKXuJv
# e7agOpwmo1iCbJkjPIHFaClH2yPSZDl+jfSerwtiXgcqXzzZ9qzVBvdQVY+SeVr8
# wrZiyAi3J9d2ptPzUSZqxxfhZz++xYlj2lJqEe/GTiDKnImKF5upzV0iGqRpbVuw
# z4OgbgDpl7N5uPpBmxCAqz2HysP+/xvvsTxtqesZI36FM7+Ib2m8m4OmXbS+l+S+
# MHyECRZvjWhYxpTkc5DvL4uiBii6tprd1OglSI92k/jI2FCb6bAmrUeInEJ6aWDQ
# I3Ml
